...
### Ease of datastores
Datastores are eased to give access to webfiles in a standarized way. Datastores implement the logic to read and store webfiles. They also implement the conversion between webfilerepresentation and datastore representation.
